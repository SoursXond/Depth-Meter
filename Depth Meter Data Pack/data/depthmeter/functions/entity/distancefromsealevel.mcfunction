...
scoreboard players set @s[predicate=depthmeter:entity/location/overworld/in_dimension] DMMaths 62
scoreboard players set @s[predicate=depthmeter:entity/location/nether/in_dimension] DMMaths 31
